...
//////////////calculate shortest patch in straight DAG////////////////
//vector<long>
//solve_graph_straight_SV(vector<pair<int, int>> vertices, vector<double> &q_dist, vector<double> &ref_dist,
//        const int w) {
//    Graph *g;
//    int size_vertices = vertices.size();
//    g = new Graph(2 + w * size_vertices);
...
/////////////////calculate shortest patch in reverse DAG/////////////////////////////
//vector<long>
//solve_graph_reverse_SV(vector<pair<int, int>> vertices, vector<double> &q_dist, vector<double> &ref_dist,
//        const int w) {
//    Graph *g;
//    int size_vertices = vertices.size();
//    g = new Graph(2 + w * size_vertices);
